...
# load negation words
negation_words = []
with open('../emotion_resources/English/others/negative/negationWords.txt', 'r') as src:
    lines = src.readlines()
    for line in lines:
...
# load degree words
how_words_dict = dict()
with open('../emotion_resources/English/HowNet/intensifierWords.txt', 'r') as src:
    lines = src.readlines()
    for line in lines:
...
lexicon_categories, lexicon_terms2arr = joblib.load(
    '../emotion_resources/English/NRC/preprocess/preprocess-lexicon.pkl')
...
intensity_categories, intensity_terms2arr = joblib.load(
    '../emotion_resources/English/NRC/preprocess/preprocess-intensity.pkl')
...
print()
pos_words = init_words('../emotion_resources/English/HowNet/正面情感词语（英文）.txt')
pos_words += init_words('../emotion_resources/English/HowNet/正面评价词语（英文）.txt')
neg_words = init_words('../emotion_resources/English/HowNet/负面情感词语（英文）.txt')
neg_words += init_words('../emotion_resources/English/HowNet/负面评价词语（英文）.txt')
...
first_pronoun = init_words(
    '../emotion_resources/English/others/pronoun/1-personal-pronoun.txt')
second_pronoun = init_words(
    '../emotion_resources/English/others/pronoun/2-personal-pronoun.txt')
third_pronoun = init_words(
    '../emotion_resources/English/others/pronoun/3-personal-pronoun.txt')
